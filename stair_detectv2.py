...
# from plane_detection_histogram_pca import segment_planes
# from plane_detection_histogram_ransac import segment_planes
from plane_detection_region_growing import segment_planes
...
def main():
    ...
    while True:
        ...
        planes = segment_planes(points, camera_rpy)
